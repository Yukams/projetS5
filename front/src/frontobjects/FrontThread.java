...
public class FrontThread extends FrontObject {
    ...
    public boolean equals(Object o) {
        ...
        return nbNotReadMessage == that.nbNotReadMessage && Objects.equals(title, that.title) && Objects.equals(group, that.group) && Objects.equals(messages, that.messages);
    }

    @Override
    public int hashCode() {
        return Objects.hash(title, group, messages, nbNotReadMessage);
    }
}
